...
uint8 EZI2C_slave_initVar = 0u;
    ...
    * EZI2C_slave_Stop() is called. Only these TX interrupt sources 
    * will be restored on a subsequent EZI2C_slave_Enable() call.
    */
    uint16 EZI2C_slave_IntrTxMask = 0u;
...
****************************************************************************//**
*
*  Initializes the EZI2C_slave component to operate in one of the selected
*  configurations: I2C, SPI, UART or EZI2C.
*  When the configuration is set to "Unconfigured SCB", this function does
*  not do any initialization. Use mode-specific initialization APIs instead:
*  EZI2C_slave_I2CInit, EZI2C_slave_SpiInit, 
*  EZI2C_slave_UartInit or EZI2C_slave_EzI2CInit.
*
*******************************************************************************/
...
****************************************************************************//**
*
*  Enables EZI2C_slave component operation: activates the hardware and 
*  internal interrupt. It also restores TX interrupt sources disabled after the 
*  EZI2C_slave_Stop() function was called (note that level-triggered TX 
*  interrupt sources remain disabled to not cause code lock-up).
*  For I2C and EZI2C modes the interrupt is internal and mandatory for 
*  operation. For SPI and UART modes the interrupt can be configured as none, 
*  internal or external.
*  The EZI2C_slave configuration should be not changed when the component
*  is enabled. Any configuration changes should be made after disabling the 
*  component.
*  When configuration is set to “Unconfigured EZI2C_slave”, the component 
...
****************************************************************************//**
*
*  Invokes EZI2C_slave_Init() and EZI2C_slave_Enable().
...
****************************************************************************//**
*
*  Disables the EZI2C_slave component: disable the hardware and internal 
*  interrupt. It also disables all TX interrupt sources so as not to cause an 
*  unexpected interrupt trigger because after the component is enabled, the 
*  TX FIFO is empty.
*  Refer to the function EZI2C_slave_Enable() for the interrupt 
...
static void EZI2C_slave_ScbModeStop(void)
{
    ...
    *******************************************************************************/
    void EZI2C_slave_SetPins(uint32 mode, uint32 subMode, uint32 uartEnableMask)
    {
        ...
        {
            EZI2C_slave_RX_SCL_MOSI_HSIOM_SEL_GPIO,
            EZI2C_slave_TX_SDA_MISO_HSIOM_SEL_GPIO,
            0u,
            0u,
            0u,
            0u,
            ...
            (EZI2C_slave_SCB_MODE_EZI2C == mode))
        {
            ...
            hsiomSel[EZI2C_slave_RX_SCL_MOSI_PIN_INDEX] = EZI2C_slave_RX_SCL_MOSI_HSIOM_SEL_I2C;
            pinsDm  [EZI2C_slave_RX_SCL_MOSI_PIN_INDEX] = EZI2C_slave_PIN_DM_OD_LO;
        #elif (EZI2C_slave_RX_WAKE_SCL_MOSI_PIN)
            hsiomSel[EZI2C_slave_RX_WAKE_SCL_MOSI_PIN_INDEX] = EZI2C_slave_RX_WAKE_SCL_MOSI_HSIOM_SEL_I2C;
            pinsDm  [EZI2C_slave_RX_WAKE_SCL_MOSI_PIN_INDEX] = EZI2C_slave_PIN_DM_OD_LO;
        #else
        #endif /* (EZI2C_slave_RX_SCL_MOSI_PIN) */
        
        #if (EZI2C_slave_TX_SDA_MISO_PIN)
            hsiomSel[EZI2C_slave_TX_SDA_MISO_PIN_INDEX] = EZI2C_slave_TX_SDA_MISO_HSIOM_SEL_I2C;
        ...
        {
        #if (EZI2C_slave_RX_SCL_MOSI_PIN)
            hsiomSel[EZI2C_slave_RX_SCL_MOSI_PIN_INDEX] = EZI2C_slave_RX_SCL_MOSI_HSIOM_SEL_SPI;
        #elif (EZI2C_slave_RX_WAKE_SCL_MOSI_PIN)
            hsiomSel[EZI2C_slave_RX_WAKE_SCL_MOSI_PIN_INDEX] = EZI2C_slave_RX_WAKE_SCL_MOSI_HSIOM_SEL_SPI;
        #else
        #endif /* (EZI2C_slave_RX_SCL_MOSI_PIN) */
        
        #if (EZI2C_slave_TX_SDA_MISO_PIN)
            hsiomSel[EZI2C_slave_TX_SDA_MISO_PIN_INDEX] = EZI2C_slave_TX_SDA_MISO_HSIOM_SEL_SPI;
        #endif /* (EZI2C_slave_TX_SDA_MISO_PIN) */
        
        #if (EZI2C_slave_SCLK_PIN)
            hsiomSel[EZI2C_slave_SCLK_PIN_INDEX] = EZI2C_slave_SCLK_HSIOM_SEL_SPI;
            ...
            if (EZI2C_slave_SPI_SLAVE == subMode)
            {
                ...
                pinsDm[EZI2C_slave_SCLK_PIN_INDEX] = EZI2C_slave_PIN_DM_DIG_HIZ;

            #if (EZI2C_slave_SS0_PIN)
                /* Only SS0 is valid choice for Slave */
                hsiomSel[EZI2C_slave_SS0_PIN_INDEX] = EZI2C_slave_SS0_HSIOM_SEL_SPI;
                pinsDm  [EZI2C_slave_SS0_PIN_INDEX] = EZI2C_slave_PIN_DM_DIG_HIZ;
            ...
            else 
            {
                ...
                pinsDm[EZI2C_slave_SCLK_PIN_INDEX] = EZI2C_slave_PIN_DM_STRONG;

            #if (EZI2C_slave_SS0_PIN)
                hsiomSel [EZI2C_slave_SS0_PIN_INDEX] = EZI2C_slave_SS0_HSIOM_SEL_SPI;
                pinsDm   [EZI2C_slave_SS0_PIN_INDEX] = EZI2C_slave_PIN_DM_STRONG;
                pinsInBuf |= EZI2C_slave_SS0_PIN_MASK;
            #endif /* (EZI2C_slave_SS0_PIN) */

            #if (EZI2C_slave_SS1_PIN)
                hsiomSel [EZI2C_slave_SS1_PIN_INDEX] = EZI2C_slave_SS1_HSIOM_SEL_SPI;
                ...
                hsiomSel [EZI2C_slave_SS2_PIN_INDEX] = EZI2C_slave_SS2_HSIOM_SEL_SPI;
                ...
                hsiomSel [EZI2C_slave_SS3_PIN_INDEX] = EZI2C_slave_SS3_HSIOM_SEL_SPI;
            ...
            #if (EZI2C_slave_SCLK_PIN)
                pinsInBuf |= EZI2C_slave_SCLK_PIN_MASK;
            #endif /* (EZI2C_slave_SCLK_PIN) */
            }
        }
        else /* UART */
        {
            if (EZI2C_slave_UART_MODE_SMARTCARD == subMode)
            {
                /* SmartCard */
            #if (EZI2C_slave_TX_SDA_MISO_PIN)
                hsiomSel[EZI2C_slave_TX_SDA_MISO_PIN_INDEX] = EZI2C_slave_TX_SDA_MISO_HSIOM_SEL_UART;
                pinsDm  [EZI2C_slave_TX_SDA_MISO_PIN_INDEX] = EZI2C_slave_PIN_DM_OD_LO;
            #endif /* (EZI2C_slave_TX_SDA_MISO_PIN) */
            }
            else /* Standard or IrDA */
            {
                ...
                {
                #if (EZI2C_slave_RX_SCL_MOSI_PIN)
                    hsiomSel[EZI2C_slave_RX_SCL_MOSI_PIN_INDEX] = EZI2C_slave_RX_SCL_MOSI_HSIOM_SEL_UART;
                    pinsDm  [EZI2C_slave_RX_SCL_MOSI_PIN_INDEX] = EZI2C_slave_PIN_DM_DIG_HIZ;
                #elif (EZI2C_slave_RX_WAKE_SCL_MOSI_PIN)
                    hsiomSel[EZI2C_slave_RX_WAKE_SCL_MOSI_PIN_INDEX] = EZI2C_slave_RX_WAKE_SCL_MOSI_HSIOM_SEL_UART;
                    pinsDm  [EZI2C_slave_RX_WAKE_SCL_MOSI_PIN_INDEX] = EZI2C_slave_PIN_DM_DIG_HIZ;
                #else
                #endif /* (EZI2C_slave_RX_SCL_MOSI_PIN) */
                }
                ...
                if (EZI2C_slave_UART_MODE_STD == subMode)
                {
                    ...
                    #if (EZI2C_slave_SCLK_PIN)
                        hsiomSel[EZI2C_slave_SCLK_PIN_INDEX] = EZI2C_slave_SCLK_HSIOM_SEL_UART;
                        pinsDm  [EZI2C_slave_SCLK_PIN_INDEX] = EZI2C_slave_PIN_DM_DIG_HIZ;
                    #endif /* (EZI2C_slave_SCLK_PIN) */
                    }
                    ...
                    #if (EZI2C_slave_SS0_PIN)
                        hsiomSel[EZI2C_slave_SS0_PIN_INDEX] = EZI2C_slave_SS0_HSIOM_SEL_UART;
                        pinsDm  [EZI2C_slave_SS0_PIN_INDEX] = EZI2C_slave_PIN_DM_STRONG;
    ...
    #if (EZI2C_slave_SCLK_PIN)
        EZI2C_slave_SET_HSIOM_SEL(EZI2C_slave_SCLK_HSIOM_REG,
                                       EZI2C_slave_SCLK_HSIOM_MASK,
                                       EZI2C_slave_SCLK_HSIOM_POS,
                                       hsiomSel[EZI2C_slave_SCLK_PIN_INDEX]);

        EZI2C_slave_spi_sclk_SetDriveMode((uint8) pinsDm[EZI2C_slave_SCLK_PIN_INDEX]);

        EZI2C_slave_SET_INP_DIS(EZI2C_slave_spi_sclk_INP_DIS,
                                     EZI2C_slave_spi_sclk_MASK,
                                     (0u != (pinsInBuf & EZI2C_slave_SCLK_PIN_MASK)));
    #endif /* (EZI2C_slave_SCLK_PIN) */

    #if (EZI2C_slave_SS0_PIN)
        EZI2C_slave_SET_HSIOM_SEL(EZI2C_slave_SS0_HSIOM_REG,
                                       EZI2C_slave_SS0_HSIOM_MASK,
                                       EZI2C_slave_SS0_HSIOM_POS,
                                       hsiomSel[EZI2C_slave_SS0_PIN_INDEX]);

        EZI2C_slave_spi_ss0_SetDriveMode((uint8) pinsDm[EZI2C_slave_SS0_PIN_INDEX]);

        EZI2C_slave_SET_INP_DIS(EZI2C_slave_spi_ss0_INP_DIS,
                                     EZI2C_slave_spi_ss0_MASK,
                                     (0u != (pinsInBuf & EZI2C_slave_SS0_PIN_MASK)));
    #endif /* (EZI2C_slave_SS0_PIN) */
