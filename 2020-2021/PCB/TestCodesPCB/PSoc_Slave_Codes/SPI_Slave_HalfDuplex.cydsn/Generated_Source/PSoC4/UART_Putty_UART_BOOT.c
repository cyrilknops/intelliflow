...
/*******************************************************************************
* Function Name: UART_Putty_UartCyBtldrCommStart
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: UART_Putty_UartCyBtldrCommStop
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: UART_Putty_UartCyBtldrCommReset
****************************************************************************//**
*
...
void UART_Putty_UartCyBtldrCommReset(void)
{
    ...
    UART_Putty_SpiUartClearRxBuffer();
    UART_Putty_SpiUartClearTxBuffer();
}


/*******************************************************************************
* Function Name: UART_Putty_UartCyBtldrCommRead
****************************************************************************//**
*
    ...
    if ((NULL != pData) && (size > 0u))
    {
        ...
        do
        {
            ...
            if (0u != UART_Putty_SpiUartGetRxBufferSize())
            {
                ...
                do
                {
                    byteCount = UART_Putty_SpiUartGetRxBufferSize();
                    CyDelayUs(UART_Putty_UART_BYTE_TO_BYTE);
                }
                while (byteCount != UART_Putty_SpiUartGetRxBufferSize());

                byteCount = UART_Putty_BYTES_TO_COPY(byteCount, size);
        ...
        {
            pData[i] = (uint8) UART_Putty_SpiUartReadRxData();
        }
    }
...
/*******************************************************************************
* Function Name: UART_Putty_UartCyBtldrCommWrite
****************************************************************************//**
*
...
cystatus UART_Putty_UartCyBtldrCommWrite(const uint8 pData[], uint16 size, uint16 * count, uint8 timeOut)
{
    ...
    if ((NULL != pData) && (size > 0u))
    {
        ...
        UART_Putty_SpiUartPutArray(pData, (uint32) size);
