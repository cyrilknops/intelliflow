...
module SPI_Slave_v2_70_1 (
	...
	assign tmpOE__bufoe_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{Net_182} : {Net_182};
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("3925cbed-9255-4faf-a66a-d8280535def9"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
