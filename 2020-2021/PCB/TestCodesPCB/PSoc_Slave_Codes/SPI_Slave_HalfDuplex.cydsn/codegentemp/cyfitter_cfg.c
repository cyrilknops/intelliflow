...
static void ClockSetup(void)
{
	...
	CY_SET_REG32((void *)(CYREG_CLK_DIVIDER_A00), 0x8000000Bu);
...
void cyfitter_cfg(void)
{
	...
	CY_SET_REG8((void *)CYREG_UDB_UDBIF_INT_CLK_CTL, 0x01u);
	{
		...
		CY_SET_REG32((void *)(CYREG_UDB_PA3_CFG12), 0x00000002u);

		/* UDB_P1_U0_CFG24 Starting address: CYDEV_UDB_P1_U0_CFG24 */
		CY_SET_REG32((void *)(CYREG_UDB_P1_U0_CFG24), 0xE4000404u);

		/* INT_SELECT Starting address: CYDEV_CPUSS_INTR_SELECT */
		CY_SET_REG32((void *)(CYREG_CPUSS_INTR_SELECT), 0x00000003u);
